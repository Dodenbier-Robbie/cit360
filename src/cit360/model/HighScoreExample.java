...
import cit360.control.HighScoreExampleControl.HighScore;
 ...
 * @author rdodenbier
 */
public class HighScoreExample implements Serializable {
    
    private HighScore playerName;
    private HighScore playerScore;
    private ArrayList<HighScoreExampleControl.HighScore> highScore;
